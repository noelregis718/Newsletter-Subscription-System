...
INSERT INTO users (email,password) VALUES('abcd@abcd','abcd');

INSERT INTO newsletters (name) VALUES('nl1'), ('nl2');
INSERT INTO subscriber (user_id,news_id) VALUES(2,1), (1,2),(1,1);
-- select * from users;
...
-- Select * from newsletters  join (Select * from users join subscriber on users.u_id = subscriber.user_id )as us on newsletters.n_id=us.news_id where email="abcd@abcd";
